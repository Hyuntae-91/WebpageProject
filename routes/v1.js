...
const fs = require('fs');
const { isLoggedIn, isNotLoggedIn, deprecated } = require('./middlewares');
const cors = require('cors');

const memberCtrl = require('./v1/memberCtrl');
const postCtrl = require('./v1/postCtrl');
const forumCtrl = require('./v1/forumCtrl');
const commentCtrl = require('./v1/commentCtrl');

const router = express.Router();

// Access-Control-Allow-Origin
router.use(cors());
// router.use(deprecated); // v2를 모두 작성한 뒤에 해당 주석을 삭제하여 새 버전을 알리기.
